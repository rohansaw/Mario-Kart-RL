...
# render = False
render = True
env = gym.make('Mario-Kart-Discrete-Luigi-Raceway-v0', random_tracks=True, containerized=True, auto_abort=False, resolution="supersmall", base_episode_length=30000)
# env.reset()
# if render:
#     env.render()
